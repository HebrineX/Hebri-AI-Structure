...
En `Hebri-AI-Harness 0.8.10`, el chat visible actúa como **intérprete** por
...
Subgates P0 y condicionales de `0.8.10`:
...
Responsabilidades nuevas de `0.8.10`:
...
En harness `0.8.10`, `spec_author` e `implementer` pueden verse como perfiles
...
## Detractor Senior y Reporter en 0.8.10
