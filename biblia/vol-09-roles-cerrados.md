...
En `Hebri-AI-Harness 0.8.9`, el chat visible actúa como **intérprete** por
...
Subgates P0 y condicionales de `0.8.9`:
...
Responsabilidades nuevas de `0.8.9`:
...
En harness `0.8.9`, `spec_author` e `implementer` pueden verse como perfiles
...
## Detractor Senior y Reporter en 0.8.9
