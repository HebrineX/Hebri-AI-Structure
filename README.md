...
- **Auditar cumplimiento del Harness 0.8.0** → [Apéndice · Operación y Auditoría de Harness 0.8.0](./biblia/apendice-harness-0-5-operacion.md)
...
Referencia operativa actual: **Hebri-AI-Harness 0.8.0**, con contrato de
...
| Auditar o regularizar Harness 0.8.0 | Apéndice Harness 0.8 |
...
Versión actual: **3.2.0**. Ver [CHANGELOG.md](./CHANGELOG.md).
