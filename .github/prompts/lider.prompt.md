...
5. Si el proyecto usa Harness 0.8.10: `PROJECT_BINDING.yaml`,
...
- En Harness 0.8.10 no cerrás ciclo sin binding válido,
  `G5I_memory_consistency_complete` y `G6_agent_closure_complete`.
