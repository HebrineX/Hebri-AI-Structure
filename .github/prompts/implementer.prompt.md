...
y respetar controles 0.8.0: binding válido, preflight, approval envelope,
...
3. Si hay Harness 0.8.0, verificar `PROJECT_BINDING.yaml`, approval envelope,
   `session-pin.md`, `memory-registry.yaml`, memory route activa,   lock y write-set.
...
- Si falta binding, approval, lock o write-set en Harness 0.8.0, bloqueás
  antes de escribir.
