...
y respetar controles 0.13.0: binding válido, Agent Contract System,
...
3. Si hay Harness 0.13.0, verificar `PROJECT_BINDING.yaml`, agent contract,
...
- Si falta binding, agent contract, capability, approval, lock o write-set en
  Harness 0.13.0, bloqueás antes de escribir.
