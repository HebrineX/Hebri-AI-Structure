...
y respetar controles 0.8.7: binding válido, preflight, approval envelope,
...
3. Si hay Harness 0.8.7, verificar `PROJECT_BINDING.yaml`, approval envelope,
...
- Si falta binding, approval, lock o write-set en Harness 0.8.7, bloqueás
  antes de escribir.
