...
y respetar controles 0.9.0: binding válido, preflight, approval envelope,
...
3. Si hay Harness 0.9.0, verificar `PROJECT_BINDING.yaml`, approval envelope,
...
- Si falta binding, approval, lock o write-set en Harness 0.9.0, bloqueás
  antes de escribir.
